  ...
  return (
    <div className='h-[100vh] w-full font-zentry bg-black flex '>
      <div className=' h-[95%] w-[45%] mt-[15vh]   px-10 flex  flex-col'>
        <h1 className='text-[10vw]  text-white z-10 uppercase hover:text-zinc-400 text-shadow-[2px_2px_25px_rgba(250,0,250,0.8)]'> hey </h1>
        <h1 className='text-[10vw] text-white z-20 uppercase hover:text-zinc-400 text-shadow-[2px_2px_22px_rgba(0,0,250,0.8)]'> there <span className=' text-shadow-[2px_2px_22px_rgba(0,250,0,0.8)] '>!</span> </h1>
